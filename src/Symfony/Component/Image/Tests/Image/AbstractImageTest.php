...
abstract class AbstractImageTest extends PhpunitTestCase
{
    ...
    public function testResizeAnimatedGifResizeResult()
    {
        ...
        $image->save(__DIR__.'/../Fixtures/results/anima2-half-size.gif', array('animated' => true));
        @unlink(__DIR__.'/../Fixtures/results/anima2-half-size.gif');
    }
    ...
    protected function processInOut($file, $in, $out)
    {
        ...
        $thumb->save(__DIR__."/../Fixtures/results/in_out/{$class}_{$file}_from_{$in}_to.{$out}");
