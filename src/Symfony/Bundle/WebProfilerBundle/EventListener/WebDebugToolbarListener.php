...
class WebDebugToolbarListener implements EventSubscriberInterface
{
    ...
    public function __construct(\Twig_Environment $twig, ContentSecurityPolicyHandler $cspHandler, $interceptRedirects = false, $mode = self::ENABLED, $position = 'bottom', UrlGeneratorInterface $urlGenerator = null, $excludedAjaxPaths = '^/bundles|^/_wdt')
    {
        $this->twig = $twig;
